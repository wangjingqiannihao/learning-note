...
![Go 手写 Reverse Proxy 实现流程图](images/反向代理流程.png)
...
// rawTarget 需要包含 scheme 和 host，例如 
...
func main() {
    ...
    log.Println("reverse proxy listening on :8080, upstream is )
